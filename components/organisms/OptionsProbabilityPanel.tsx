  ...
  return (
    <div className="glass-card mt-10 p-6 border border-white/5 bg-black/40 backdrop-blur-md relative overflow-hidden group rounded-xl">
       <div className="flex items-center gap-3 mb-6">
         ...
         <h3 className="text-[11px] font-bold text-[#38bdf8] uppercase tracking-[0.15em] leading-none">Options Engine</h3>
       </div>

       <div className="space-y-6">
         {/* ATM Implied Volatility */}
         <div>
            <div className="text-[10px] font-bold text-zinc-500 uppercase tracking-[0.15em] mb-1.5">Implied Volatility (ATM)</div>
         ...
         <div className="pt-4 border-t border-white/5 space-y-4">
            <div>
               <div className="text-[10px] font-bold text-zinc-500 uppercase tracking-[0.15em] mb-1.5 flex justify-between">
            ...
            <div className="flex items-center justify-between">
              <div className="flex flex-col gap-1">
                 <span className="text-[10px] font-bold text-bull uppercase tracking-[0.15em]">Upper Bound</span>
              ...
              <div className="flex flex-col gap-1 text-right">
                 <span className="text-[10px] font-bold text-bear uppercase tracking-[0.15em]">Lower Bound</span>
         ...
         {data.putCallRatio > 0 && (
           <div className="pt-4 border-t border-white/5 flex items-center justify-between">
             <span className="text-[10.5px] font-bold text-zinc-500 uppercase tracking-[0.15em]">Put/Call Ratio</span>
         ...
         <div className="pt-4 text-[10px] text-zinc-600 font-bold uppercase tracking-[0.15em] leading-relaxed">
