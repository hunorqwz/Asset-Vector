  ...
  return (
    <div className="flex flex-col items-center justify-center p-12 glass-card border border-white/10 relative overflow-hidden h-full min-h-[400px]">
      <button
        ...
        className="w-16 h-16 rounded-full border border-white/10 bg-white/5 hover:bg-white/10 flex items-center justify-center mb-6 transition-all active:scale-95"
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-white opacity-80">
          <path d="M12 5v14m-7-7h14"/>
        </svg>
      </button>
      <h3 className="text-lg font-semibold text-white mb-2">No Assets Tracked</h3>
      <p className="text-[13px] font-medium text-zinc-500 text-center max-w-sm leading-relaxed">
